 ...
 * Evaluates tokens against threshold criteria and assigns precise rejection reasons based on Token Address Identity.
 */
...
export function filterCandidateTokens(uniqueTokens = []) {
  ...
  for (const token of uniqueTokens) {
    ...
    // 2. Token Address & Asset Identity Verification
