...
export function filterCandidateTokens(uniqueTokens = []) {
  ...
  const dynamicDiagnosticMessage = `${passedCandidates.length} valid token candidates found (${diagnosticsStats.passedAssetFilter} real SPL tokens evaluated).`;
