 ...
 * Server-side constants for discovery filtering and calibration diagnostics.
 */
...
export const HUNTER_CONFIG = {
  ...
  EXCLUDED_TOKEN_ADDRESSES: new Set([
  ...
  // Symbols to avoid if token address missing or native asset
