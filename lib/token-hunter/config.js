 ...
 * Server-side constants for discovery filtering, calibration, and precise asset classification.
 */

export const HUNTER_CONFIG = {
  // Configurable Thresholds for Candidate Discovery
  ...
  // Known Major Stablecoin Mint Addresses on Solana
  ...
  // Known Infrastructure & Staked SOL Token Addresses on Solana
